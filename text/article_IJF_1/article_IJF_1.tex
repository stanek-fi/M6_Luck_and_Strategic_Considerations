...
\begin{table}[!htbp]
    ...
    \begin{subtable}{.5\linewidth} 
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_asy_sensitivity_1.csv}
        \caption{WYY (asy.)}
        \label{tab:test_IR_level_table_asy_sensitivity_1}
    \end{subtable}%
    \begin{subtable}{.5\linewidth}
        \centering
        \pgfplotstabletypeset[
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_wb_sensitivity_1.csv}
        \caption{WYY (w.b.)}
        \label{tab:test_IR_level_table_wb_sensitivity_1}
    \end{subtable}
    \caption{Rejection Rates of WYY Tests under A1-a\\
    }
    \label{tab:combined_rejection_rates_sensitivity_1}
\end{table}
...
\begin{table}[!htbp]
    ...
    \begin{subtable}{.5\linewidth} 
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_asy_sensitivity_2.csv}
        \caption{WYY (asy.)}
        \label{tab:test_IR_level_table_asy_sensitivity_2}
    \end{subtable}%
    \begin{subtable}{.5\linewidth}
        \centering
        \pgfplotstabletypeset[
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_wb_sensitivity_2.csv}
        \caption{WYY (w.b.)}
        \label{tab:test_IR_level_table_wb_sensitivity_2}
    \end{subtable}
    \caption{Rejection Rates of WYY Tests under A1-b\\
    }
    \label{tab:combined_rejection_rates_sensitivity_2}
\end{table}
...
\begin{table}[!htbp]
    ...
    \begin{subtable}{.5\linewidth} 
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_asy_sensitivity_3.csv}
        \caption{WYY (asy.)}
        \label{tab:test_IR_level_table_asy_sensitivity_3}
    \end{subtable}%
    \begin{subtable}{.5\linewidth}
        \centering
        \pgfplotstabletypeset[
        ...
        display columns/2/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=50$}},
        display columns/3/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$K=163$}}
        ]{../../outputs/tables/test_IR_level_table_wb_sensitivity_3.csv}
        \caption{WYY (w.b.)}
        \label{tab:test_IR_level_table_wb_sensitivity_3}
    \end{subtable}
    \caption{Rejection Rates of WYY Tests under A1-c\\
    }
    \label{tab:combined_rejection_rates_sensitivity_3}
\end{table}

Tables \ref{tab:state_table_sensitivity_1}, \ref{tab:state_table_sensitivity_2}, and \ref{tab:state_table_sensitivity_3} present $\mathbb{E}[IR_{T_{1}:T_{12},k}]$ and the probability of securing a rank $q \in \{1,\,5,\,10,\,20\}$ when simulating the competition under A1'-a/A1'-b/A1'-c and A2. 
The results closely resemble those in Table~\ref{tab:state_table}, indicating that our main conclusions remain robust to introducing heavy-tailed distributions and conditional heteroskedasticity.
...
\begin{table}[!htbp]
    ...
    display columns/5/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 10$}},
    display columns/6/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 20$}}
    ]{../../outputs/tables/state_table_simulated_rank_optimization_sensitivity_1.csv}
    \caption{Comparison of Performance (Simulated under A1-a)}
    \label{tab:state_table_sensitivity_1}
\end{table}
...
\begin{table}[!htbp]
    ...
    display columns/5/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 10$}},
    display columns/6/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 20$}}
    ]{../../outputs/tables/state_table_simulated_rank_optimization_sensitivity_2.csv}
    \caption{Comparison of Performance (Simulated under A1-b)}
    \label{tab:state_table_sensitivity_2}
\end{table}
...
\begin{table}[!htbp]
    ...
    display columns/5/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 10$}},
    display columns/6/.style={dec sep align, precision = 3, fixed, fixed zerofill=true, column name={$ q = 20$}}
    ]{../../outputs/tables/state_table_simulated_rank_optimization_sensitivity_3.csv}
    \caption{Comparison of Performance (Simulated under A1-c)}
    \label{tab:state_table_sensitivity_3}
\end{table}
